...
import 'package:quiz_riddles/preparatoria/cuestionarios_prepa.dart';
import 'package:quiz_riddles/preparatoria/cursos_prepa.dart';
import 'package:quiz_riddles/preparatoria/estadisticas_prepa.dart';
import 'package:quiz_riddles/preparatoria/notificactions_prepa.dart';
import 'package:quiz_riddles/preparatoria/recursos_prepa.dart';
import 'package:quiz_riddles/home_screens/home_screen_principal.dart';
import 'package:quiz_riddles/nav_bar_test.dart';

class HomeScreenPrepa extends StatelessWidget {
  const HomeScreenPrepa({super.key});
                    ...
                    FilledButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const CursosPrepa()));
                      },
                      child: const Text(
                        'Empezar',
                        style: TextStyle(
